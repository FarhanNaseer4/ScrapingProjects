...
class KentuckybidsSpiderSpider(scrapy.Spider):
    name = 'kentuckybids_spider'
    start_urls = ['https://www.kentuckybids.us/kentucky-contractors/category.htm']

    base_url = 'https://www.kentuckybids.us{}'
    custom_settings = {
        'FEED_URI': 'kentuckybids.csv',
        'FEED_FORMAT': 'csv',
    ...
    def listing_page(self, response):
        for data in response.css('div.innertube div.list-one'):
            ...
            if detail_url:
                ...
                item['Source_URL'] = 'https://www.kentuckybids.us/kentucky-contractors/category.htm'
                item['Lead_Source'] = 'kentuckybids'
