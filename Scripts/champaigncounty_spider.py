...
class ChampaigncountySpiderSpider(scrapy.Spider):
    name = 'champaigncounty_spider'
    start_urls = ['https://www.champaigncounty.org/list']
    custom_settings = {
        'FEED_URI': 'champaigncounty.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        item = dict()
        item['Business Name'] = response.css('div.cms-design-panel h1::text').get('').strip()
        ...
        item['Source_URL'] = 'https://www.champaigncounty.org/list'
        item['Lead_Source'] = 'champaigncounty'
