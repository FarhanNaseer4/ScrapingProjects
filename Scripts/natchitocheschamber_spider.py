...
class NatchitocheschamberSpiderSpider(scrapy.Spider):
    name = 'natchitocheschamber_spider'
    start_urls = ['https://www.natchitocheschamber.com/list']

    custom_settings = {
        'FEED_URI': 'natchitocheschamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        ...
        item['Source_URL'] = 'https://www.natchitocheschamber.com/list'
        item['Occupation'] = response.css('span.gz-cat::text').get('').strip()
        item['Lead_Source'] = 'natchitocheschamber'
