...
class GofarmingtonSpider(scrapy.Spider):
    name = 'gofarmington'
    start_urls = ['https://www.gofarmington.com/list/']

    custom_settings = {
        'FEED_URI': 'gofarmington.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://www.gofarmington.com/list/'
