...
class NcMhaSpiderSpider(scrapy.Spider):
    name = 'nc_mha_spider'
    start_urls = ['https://www.nc-mha.org/list']
    ...
    def detail_page(self, response):
        ...
        item['Source_URL'] = 'https://www.nc-mha.org/list'
        item['Occupation'] = response.css('div.gz-details-categories p span::text').get('').strip()
        item['Lead_Source'] = 'nc-mha'
