...
class BastropchamberSpiderSpider(scrapy.Spider):
    name = 'bastropchamber_spider'
    start_urls = ['https://business.bastropchamber.com/list/']

    custom_settings = {
        'FEED_URI': 'bastropchamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        ...
        item['Source_URL'] = 'https://business.bastropchamber.com/list/'
        item['Occupation'] = response.css('span.gz-cat::text').get('').strip()
        item['Lead_Source'] = 'business.bastropchamber'
