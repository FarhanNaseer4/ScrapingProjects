...
class OrlandparkchamberSpider(scrapy.Spider):
    name = 'orlandparkchamber'
    start_urls = ['https://business.orlandparkchamber.org/list']

    custom_settings = {
        'FEED_URI': 'orlandparkchamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://business.orlandparkchamber.org/list'
            item['Occupation'] = response.css('span.gz-cat::text').get('').strip()
            item['Lead_Source'] = 'business.orlandparkchamber'
