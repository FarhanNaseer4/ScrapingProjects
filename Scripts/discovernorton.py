...
class DiscovernortonSpider(scrapy.Spider):
    name = 'discovernorton'
    start_urls = ['https://discovernorton.com/list']

    custom_settings = {
        'FEED_URI': 'discovernorton.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://discovernorton.com/list'
            item['Occupation'] = response.css('span.gz-cat::text').get('').strip()
            item['Lead_Source'] = 'iscovernorton'
