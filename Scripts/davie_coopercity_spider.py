...
class DavieCoopercitySpiderSpider(scrapy.Spider):
    name = 'davie_coopercity_spider'
    request_api = 'https://members.davie-coopercity.org/list/searchalpha/{}'
    first_name = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u',
                  'v', 'w', 'x', 'y', 'z']
    custom_settings = {
        'FEED_URI': 'davie_coopercity.csv',
        'FEED_FORMAT': 'csv',
    ...
    def parse(self, response):
        for data in response.css('div.mn-listingcontent'):
            ...
            item['Source_URL'] = 'https://members.davie-coopercity.org/list/searchalpha/a'
            item['Lead_Source'] = 'members.davie-coopercity'
