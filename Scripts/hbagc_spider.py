...
class HbagcSpiderSpider(scrapy.Spider):
    name = 'hbagc_spider'
    start_urls = ['https://members.hbagc.net/list']
    ...
    def detail_page(self, response):
        ...
        item['Category'] = ', '.join(data.css('::text').get() for data in response.css('ul.mn-member-cats li'))
        ...
        item['Full Name'] = response.css('div.mn-member-repname::text').get('').strip()
        item['Source_URL'] = 'https://members.hbagc.net/list'
        item['Occupation'] = 'Business Service'
        item['Lead_Source'] = 'hbagc'
