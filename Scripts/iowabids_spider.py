...
class IowabidsSpiderSpider(scrapy.Spider):
    name = 'iowabids_spider'
    start_urls = ['https://www.iowabids.us/iowa-contractors/category.htm']

    base_url = 'https://www.iowabids.us{}'
    custom_settings = {
        'FEED_URI': 'iowabids.csv',
        'FEED_FORMAT': 'csv',
    ...
    def listing_page(self, response):
        for data in response.css('div.innertube div.list-one'):
            ...
            if detail_url:
                ...
                item['Source_URL'] = 'https://www.iowabids.us/iowa-contractors/category.htm'
                item['Lead_Source'] = 'iowabids'
                item['Occupation'] = 'Contractors'
    ...
    def detail_page(self, response):
        ...
        item['Occupation'] = 'Contractors'
        item['Record_Type'] = 'Person'
        item['Meta_Description'] = 'Contractors in Iowa'
        item['Scraped_date'] = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        yield item
