...
class ArnoldchamberSpiderSpider(scrapy.Spider):
    name = 'arnoldchamber_spider'
    start_urls = ['https://arnoldchamber.org/list']

    custom_settings = {
        'FEED_URI': 'arnoldchamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        ...
        item['Source_URL'] = 'https://arnoldchamber.org/list'
        item['Occupation'] = response.css('ul.mn-member-cats li::text').get('').strip()
        item['Lead_Source'] = 'arnoldchamber'
