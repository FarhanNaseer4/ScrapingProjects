...
class MichiganbidsSpiderSpider(scrapy.Spider):
    name = 'michiganbids_spider'
    start_urls = ['https://www.michiganbids.us/michigan-contractors/category.htm']

    base_url = 'https://www.michiganbids.us{}'
    custom_settings = {
        'FEED_URI': 'michiganbids.csv',
        'FEED_FORMAT': 'csv',
    ...
    def listing_page(self, response):
        for data in response.css('div.innertube div.list-one'):
            ...
            if detail_url:
                ...
                item['Source_URL'] = 'https://www.michiganbids.us/michigan-contractors/category.htm'
                item['Lead_Source'] = 'michiganbids'
