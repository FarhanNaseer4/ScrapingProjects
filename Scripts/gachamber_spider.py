...
class GachamberSpiderSpider(scrapy.Spider):
    name = 'gachamber_spider'
    start_urls = ['https://web.gachamber.com/allcategories']
    base_url = 'https://web.gachamber.com{}'
    custom_settings = {
        'FEED_URI': 'gachamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def listing_page(self, response):
        for data in response.css('div.ListingResults_All_CONTAINER'):
            ...
            item['Source_URL'] = 'https://web.gachamber.com/allcategories'
