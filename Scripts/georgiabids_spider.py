...
class GeorgiabidsSpiderSpider(scrapy.Spider):
    name = 'georgiabids_spider'
    start_urls = ['https://www.georgiabids.us/georgia-contractors/category.htm']

    base_url = 'https://www.georgiabids.us{}'
    custom_settings = {
        'FEED_URI': 'georgiabids.csv',
        'FEED_FORMAT': 'csv',
    ...
    def listing_page(self, response):
        for data in response.css('div.innertube div.list-one'):
            ...
            if detail_url:
                ...
                item['Source_URL'] = 'https://www.georgiabids.us/georgia-contractors/category.htm'
                item['Lead_Source'] = 'georgiabids'
