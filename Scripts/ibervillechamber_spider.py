...
class IbervillechamberSpiderSpider(scrapy.Spider):
    name = 'ibervillechamber_spider'
    start_urls = ['https://business.ibervillechamber.com/list']

    custom_settings = {
        'FEED_URI': 'ibervillechamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        ...
        item['Source_URL'] = 'https://business.ibervillechamber.com/list'
        item['Occupation'] = response.css('span.gz-cat::text').get('').strip()
        item['Lead_Source'] = 'business.ibervillechamber'
