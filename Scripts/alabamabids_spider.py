...
class AlabamabidsSpiderSpider(scrapy.Spider):
    name = 'alabamabids_spider'
    start_urls = ['https://www.alabamabids.us/alabama-contractors/category.htm']

    base_url = 'https://www.alabamabids.us{}'
    custom_settings = {
        'FEED_URI': 'alabamabids.csv',
        'FEED_FORMAT': 'csv',
    ...
    def listing_page(self, response):
        for data in response.css('div.innertube div.list-one'):
            ...
            if detail_url:
                ...
                item['Source_URL'] = 'https://www.alabamabids.us/alabama-contractors/category.htm'
                item['Lead_Source'] = 'alabamabids'
