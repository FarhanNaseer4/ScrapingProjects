...
class HarrisburgsdchamberSpider(scrapy.Spider):
    name = 'harrisburgsdchamber'
    start_urls = ['https://www.harrisburgsdchamber.com/list']

    custom_settings = {
        'FEED_URI': 'harrisburgsdchamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://www.harrisburgsdchamber.com/list'
            ...
            item['Lead_Source'] = 'harrisburgsdchamber'
