...
class HarborspringschamberSpiderSpider(scrapy.Spider):
    name = 'harborspringschamber_spider'
    start_urls = ['https://www.harborspringschamber.com/list/']
    custom_settings = {
        'FEED_URI': 'harborspringschamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        ...
        item['Source_URL'] = 'https://www.harborspringschamber.com/list/'
        item['Occupation'] = response.css('span.gz-cat::text').get('').strip()
        item['Lead_Source'] = 'harborspringschamber'
