...
class NoblesvillechamberSpider(scrapy.Spider):
    name = 'noblesvillechamber'
    start_urls = ['https://www.noblesvillechamber.com/list']

    custom_settings = {
        'FEED_URI': 'noblesvillechamber.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        try:
            ...
            item['Source_URL'] = 'https://www.noblesvillechamber.com/list'
            ...
            item['Lead_Source'] = 'noblesvillechamber'
