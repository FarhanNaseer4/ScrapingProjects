...
class OregonwiSpiderSpider(scrapy.Spider):
    name = 'oregonwi_spider'
    start_urls = ['https://www.oregonwi.com/list/']

    custom_settings = {
        'FEED_URI': 'oregonwi.csv',
        'FEED_FORMAT': 'csv',
    ...
    def detail_page(self, response):
        ...
        item['Source_URL'] = 'https://www.oregonwi.com/list/'
        item['Occupation'] = response.css('ul.mn-member-cats li::text').get('').strip()
        item['Lead_Source'] = 'oregonwi'
