...
class DumpsterrentalSpiderSpider(scrapy.Spider):
    name = 'dumpsterrental_spider'
    start_urls = ['https://www.hometowndumpsterrental.com/junk-removal']
    custom_settings = {
        'FEED_URI': 'hometowndumpsterrental.csv',
        'FEED_FORMAT': 'csv',
    ...
    def parse_listing(self, response):
        for data in response.css('div.flex-head'):
            ...
            if detail_url:
                ...
                item['Source_URL'] = 'https://www.hometowndumpsterrental.com/junk-removal'
                item['Lead_Source'] = 'hometowndumpsterrental'
                item['Occupation'] = 'Junk Removal'
