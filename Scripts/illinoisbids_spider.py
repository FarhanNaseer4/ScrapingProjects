...
class IllinoisbidsSpiderSpider(scrapy.Spider):
    name = 'illinoisbids_spider'
    start_urls = ['https://www.illinoisbids.us/illinois-contractors/category.htm']

    base_url = 'https://www.illinoisbids.us{}'
    custom_settings = {
        'FEED_URI': 'illinoisbids.csv',
        'FEED_FORMAT': 'csv',
    ...
    def listing_page(self, response):
        for data in response.css('div.innertube div.list-one'):
            ...
            if detail_url:
                ...
                item['Source_URL'] = 'https://www.illinoisbids.us/illinois-contractors/category.htm'
                item['Lead_Source'] = 'illinoisbids'
