...
class BartlettareachamberSpiderSpider(scrapy.Spider):
    name = 'bartlettareachamber_spider'
    start_urls = ['https://business.bartlettareachamber.com/list']

    custom_settings = {
        'FEED_URI': 'bartlettareachamber_data.csv',
        'FEED_FORMAT': 'csv',
    ...
    headers = {
        'authority': 'business.bartlettareachamber.com',
    ...
    def detail_page(self, response):
        ...
        item['Source_URL'] = 'https://bartlettareachamber.com/resources/'
        item['Occupation'] = 'Attorneys'
        item['Lead_Source'] = 'bartlettareachamber'
