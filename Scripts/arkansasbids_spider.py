...
class ArkansasbidsSpiderSpider(scrapy.Spider):
    name = 'arkansasbids_spider'
    start_urls = ['https://www.arkansasbids.us/arkansas-contractors/category.htm']

    base_url = 'https://www.arkansasbids.us{}'
    custom_settings = {
        'FEED_URI': 'arkansasbids.csv',
        'FEED_FORMAT': 'csv',
    ...
    def listing_page(self, response):
        for data in response.css('div.innertube div.list-one'):
            ...
            if detail_url:
                ...
                item['Source_URL'] = 'https://www.arkansasbids.us/arkansas-contractors/category.htm'
                item['Lead_Source'] = 'arkansasbids'
