...
class OhiobidsSpiderSpider(scrapy.Spider):
    name = 'ohiobids_spider'
    start_urls = ['https://www.ohiobids.us/ohio-contractors/category.htm']

    base_url = 'https://www.ohiobids.us{}'
    custom_settings = {
        'FEED_URI': 'ohiobids.csv',
        'FEED_FORMAT': 'csv',
    ...
    def listing_page(self, response):
        for data in response.css('div.innertube div.list-one'):
            ...
            if detail_url:
                ...
                item['Source_URL'] = 'https://www.ohiobids.us/ohio-contractors/category.htm'
                item['Lead_Source'] = 'ohiobids'
